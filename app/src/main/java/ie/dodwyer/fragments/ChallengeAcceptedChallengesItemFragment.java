...
public class ChallengeAcceptedChallengesItemFragment extends ListFragment {
    ...
    public ChallengeAcceptedChallengesItemFragment(){
    }

    public static ChallengeAcceptedChallengesItemFragment newInstance() {
        ChallengeAcceptedChallengesItemFragment fragment = new ChallengeAcceptedChallengesItemFragment();
        return fragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        noChallengesAcceptedChallengesTextView = (TextView) getActivity().findViewById(R.id.noChallengesAcceptedChallengesTextView);
    }
    ...
    private void populateAdapterWithFilter(){
        ...
        listAdapter = new ChallengeListAdapter(activity, null,null,null, challengeList, R.layout.challenge_accepted_challenges_row);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        swipeLayout.setOnRefreshListener(new AcceptedChallengesOnRefreshListener());
    ...
    public class AcceptedChallengesOnRefreshListener implements SwipeRefreshLayout.OnRefreshListener {
        @Override
